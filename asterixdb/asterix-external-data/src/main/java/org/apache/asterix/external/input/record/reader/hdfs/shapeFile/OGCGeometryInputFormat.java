...
public class OGCGeometryInputFormat extends AbstractShpInputFormat<VoidPointable>
{
    ...
    public RecordReader<Void, VoidPointable> getRecordReader(InputSplit inputSplit, JobConf conf, Reporter reporter) throws IOException {
        try {
            return new ShapeFileReader(inputSplit, conf, reporter,recordType);
    ...
    private static final class ShapeFileReader extends AbstractShapeReader<VoidPointable>
    {
        ...
        public ShapeFileReader(
                ...
                JobConf conf, Reporter reporter, ARecordType recordType) throws IOException, InterruptedException
        {
        ...
        public boolean next(Void key, VoidPointable value) throws IOException {
            ...
            if (fieldIndex < 0) {
                ...
                AMutableString str = new AMutableString("geometry");
